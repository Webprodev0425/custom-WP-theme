...
if ( ! class_exists( 'PPW_Migration_Manager_Services' ) ) {
	class PPW_Migration_Manager_Services extends PPW_Migration_Manager {
		...
		public function get_updater_label() {
			return sprintf( '<strong>%s </strong> &#8211;', __( 'Password Protect WordPress Pro', 'password-protect-page' ) );
		}
